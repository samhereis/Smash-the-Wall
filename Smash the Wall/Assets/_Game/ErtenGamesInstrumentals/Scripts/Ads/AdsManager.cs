...
namespace Services
{
    ...
    public class AdsManager : MonoBehaviour
    {
        ...
        public void ApplySdks()
        {
            ...
            PlayerSettings.SetScriptingDefineSymbols(namedBuildTarget, string.Join(";", allDefines.ToArray()));
        ...
        public async
            ...
            Task<bool>
#endif
            Request(string placementString, float timeout)
        {
        ...
        public async
            ...
            Task<bool>
#endif
            TryShowPlacement(string placementString)
        {
