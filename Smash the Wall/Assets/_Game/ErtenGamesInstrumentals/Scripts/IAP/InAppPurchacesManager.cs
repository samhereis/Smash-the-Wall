...
namespace Services
{
    public class InAppPurchacesManager : MonoBehaviour, IDetailedStoreListener
    {
        ...
        [ShowInInspector] private bool _autoInitialize = false;
        [ShowInInspector] private bool _subscriptionsInEditor;
        [ShowInInspector] public Item[] items { get; private set; }
