...
namespace UI.Helpers
{
    ...
    public class GridLayoutGroupHelper_Y : GridLayoutGroupHelper, ISelfValidator
    {
        protected override void SetGridLayoutSizes()
        {
            if (_parent == null) return;

            float horrizontal = NumberHelper.GetNumberFromPercentage(_parent.rect.size.y, _horrizontalOffset);
