...
namespace Gameplay
{
    ...
    {
        [Header("Settings")]
        [SerializeField] private Color _ccurrentColor;
        [SerializeField] private int _size = 150;

        [Header("Debug - Current Image")]
        [SerializeField] private Texture2D _paintTexture;
        [SerializeField] private Texture2D _originalTexture;
        [SerializeField] private SpriteRenderer _spriteRenderer;
        [SerializeField] private Color _originalColor;

        [Header("Debug - Current Image Properties")]
        [SerializeField] private Vector3 _offset;
        [SerializeField] private int _rectWidth;
        [SerializeField] private int _rectHeight;
        ...
        [SerializeField] private Rect _spriteRect;
